...
```{r}
corpus <- data.frame(
Title = c("Sir Gawayne and the Green Knight", "Oedipus King of Thebes", "The Secret Garden", "The Story of the Three Little Pigs", "The Painted Veil", "The Extraordinary Adventures of Arsène Lupin, Gentleman-Burglar", "The Way of the World", "Struwwelpeter: Merry Stories and Funny Pictures", "The Big Trip Up Yonder", "Aurora Leigh"),
logo = ""
)
```
